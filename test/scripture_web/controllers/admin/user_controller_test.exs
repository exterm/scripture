defmodule ScriptureWeb.Admin.UserControllerTest do
  use ScriptureWeb.ConnCase

  alias Scripture.Accounts

  @create_attrs %{email: "some content", first_name: "some content", last_name: "some content"}
